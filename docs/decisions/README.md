...
- [0027: Reject relative Loredu homes](./0027-reject-relative-loredu-homes.md) — requires absolute configured and OS home paths so named/default store identity never changes with cwd; narrowly supersedes ADR 0022's acceptance of any nonempty configured home
