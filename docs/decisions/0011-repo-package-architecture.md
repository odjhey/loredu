...
[Decision 0021](./0021-workspace-boundary-checker-selection.md) supersedes only this paragraph's dependency-cruiser-first selection sequence; the architectural rules and deliberate-RED requirement remain in force.
