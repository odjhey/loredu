...
| [Application and CLI contract](./architecture/contracts/application-cli.md) | Exact M1.5 protocol and additive M2 Current Knowledge envelope, affordances, temporal grammar, and feedback |
