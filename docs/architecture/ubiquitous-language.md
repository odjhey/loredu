...
| **Working Lore** | Bounded, ranked projection prepared for one activity. Its compact sections carry full counts, fixed-cardinality Scope/key previews, Basis-pinned continuations, and anchor/record handles for complete disclosure. |
