...
| **Basis** | Exactly stream position, structural RulesetIdentity, and canonical JSON query. Current Knowledge always records its resolved canonical `valid_at` in the query. `computed_at` is outside Basis and equality. |
