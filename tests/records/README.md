...
Catalog rows **T01–T08, T19, T80, T83–T85, T87** live here. The live `public-entry-append.test.ts`, `record-foundation.test.ts`, and `application-append.test.ts` suites implement all of them; policy/Basis primitives T81–T82 live in reconciliation tests. Drive only public `@loredu/kernel` and `@loredu/kernel/testing` exports.
